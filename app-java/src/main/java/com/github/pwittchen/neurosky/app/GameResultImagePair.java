...
public class GameResultImagePair extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_game_result_imagepair);
...
//        lastTimeRecord.setText(list.get(1).toString());
        ...
        btn_home.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                startActivity(intent, ActivityOptions.makeSceneTransitionAnimation(GameResultImagePair.this).toBundle());
            }
        });
