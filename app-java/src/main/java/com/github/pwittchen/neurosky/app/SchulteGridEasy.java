    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        button4.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                //音樂暫停
                music.pause();
                AlertDialog.Builder dialog = new AlertDialog.Builder(SchulteGridEasy.this);
                dialog.setTitle("請點擊以下按鈕，選擇離開 / 繼續？");
                dialog.setNegativeButton("離開",new DialogInterface.OnClickListener() {
                    @Override
                    public void onClick(DialogInterface arg0, int arg1) {
                        // TODO Auto-generated method stub
                        Toast.makeText(SchulteGridEasy.this, "離開訓練",Toast.LENGTH_SHORT).show();
                        Intent intent = new Intent();
                        intent.setClass(SchulteGridEasy.this,GameHome.class);
                        startActivity(intent, ActivityOptions.makeSceneTransitionAnimation(SchulteGridEasy.this).toBundle());
                        //音樂釋放
                        music.release();
                        music=null;
                        finish();
                ...
                dialog.setPositiveButton("繼續",new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface arg0, int arg1) {
                        // TODO Auto-generated method stub
                        Toast.makeText(SchulteGridEasy.this, "繼續訓練",Toast.LENGTH_SHORT).show();
